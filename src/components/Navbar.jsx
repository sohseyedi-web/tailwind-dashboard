...
const Navbar = () => {
  return (
    <header className="w-full py-4 px-9 flex items-center justify-between border-b border-gray-300 border-solid">
      <div className="text-3xl text-[#1a5cff] font-semibold">شمیم</div>
      <div className="flex items-center">
        <div className="mr-4 flex w-9 h-9 items-center justify-center rounded-full border-2 border-solid border-[#d7dce8] relative">
